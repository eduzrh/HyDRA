...
For large-scale preprocessing details, see [Preprocess/README.md](Preprocess/README.md).
...
| `--add_noise`        | flag  | off          | Sec. 5.6: mask name-embedding dims in Stage 1 (Simple-HHEA)                      |
| `--noise_ratio`      | float | 0.0          | Fraction of 64-d name-embedding dims to zero when `--add_noise` is set (0.0–1.0) |
